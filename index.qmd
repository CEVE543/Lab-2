---
title: "CEVE 543 Fall 2025 Lab 2: Julia Data Handling"
...
houston_gev = GeneralizedExtremeValue(μ, σ, ξ)  # <1>
```
...
function gev_return_level(gev_dist, return_period)
	μ, σ, ξ = params(gev_dist)  # <1>
	if abs(ξ) < 1e-6  # Gumbel case
		return μ - σ * log(-log(1 - 1 / return_period))  # <2>
	else
		return μ - (σ / ξ) * (1 - (-log(1 - 1 / return_period))^(-ξ))  # <3>
	end
end
